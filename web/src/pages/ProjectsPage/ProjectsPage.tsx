...
const ProjectsPage = () => {
  return (
    <>
      ...
      <h1>Projects</h1>
      <p>
        These page contains a collection of my projects that I think are worth
        publicly sharing.
      </p>

      <ProjectItem title='Canvas'>
        A digital canvas webapp. Provides basic features for creating raster
        images. Installable as a PWA.
      </ProjectItem>
