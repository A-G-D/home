...
const ContactMe = () => {
  ...
  return (
    <section className='bg-gray-200 px-8 py-8 flex flex-col gap-12 items-center rounded-[8px]'>
      ...
      <button
        className='bg-primary-500 hover:bg-white border-primary-500 border-2 shadow-lg text-white hover:text-primary-500 text-xl font-medium rounded-full max-w-max px-4 py-3 transition duration-300'
